...
namespace Win
{
	...
	{
	public:
		Message (unsigned int msg, WPARAM wParam = 0, LPARAM lParam = 0)
			: _msg (msg),
			  _wParam (wParam),
			  _lParam (lParam),
			  _result (0)
		...
		WPARAM GetWParam () const { return _wParam; }
		...
		// Revisit: this is not portable
		LPARAM GetLParam () const { return _lParam; }
		// Revisit: this is not portable
		LRESULT GetResult () const { return _result; }
	...
	public:
		...
		UserMessage (unsigned int msg, WPARAM wParam = 0, LPARAM lParam = 0)
